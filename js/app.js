(() => {
    ...
    let columnMenu = document.querySelector("#wrapper__column--menu");
    ...
    let spoilerTitle = document.querySelector("#country-header__title--active");
    let spoilerContent = document.querySelector("#body-country");
    spoilerTitle.addEventListener("click", (function() {
        spoilerContent.classList.toggle("spoiler__content--visible");
    }));
    let spoilerItems = document.querySelectorAll(".body-country__list");
    spoilerItems.forEach((function(item) {
        item.addEventListener("click", (function() {
            spoilerTitle.innerHTML = this.innerHTML;
        }));
    }));
    let searchButton = document.querySelector("#menu-header__search");
    let searchPopup = document.querySelector("#search-popup");
    let searchForm = document.querySelector("#search-popup__form");
    ...
    const FooterText = document.querySelector(".footer__text-top");
